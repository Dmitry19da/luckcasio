...
buttonGetSignal.innerText = language === "en" ? "получить сигнал" : "get signal";
...
function startCooldown(seconds) {
    ...
    const interval = setInterval(() => {
        remainingTime--;
        buttonGetSignal.innerText = language === "en" ? `Подождите ${remainingTime} сек` : `Wait ${remainingTime} sec`;
